...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ring-offset-background",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-primary/90 to-primary text-primary-foreground shadow-[0_10px_40px_-20px_rgba(0,0,0,0.45)] hover:from-primary hover:to-primary/80",
        outline:
          "border border-border bg-card text-foreground shadow-sm hover:border-foreground/30 hover:text-foreground",
