...
import type {AreaEntity, SceneRoot} from '@/features/scene/types/types'

import {ensureCanvasGridImages} from '@/features/scene/map/mapbox-grid-images'
import {computeBounds} from '@/features/scene/map/selection-geometry'
...
const cloneMapStyle = (map: MapboxMap): StyleSpecification => {
  ...
  return sanitizeSnapshotStyle(clonedStyle as StyleSpecification)
}
