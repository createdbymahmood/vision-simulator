...
import {serializeScene} from '@/features/scene/utils/scene-serializer'
import {useHistoryStore} from '@/features/scene/state/history.store'
import {useSceneStore} from '@/features/scene/state/scene.store'
import {useUiStore} from '@/features/scene/state/ui.store'
import {TopPanel} from '@/features/scene/components/top-panel'
import {useEditorUnsavedChangesGuard} from '@/features/scene/hooks/use-editor-unsaved-changes-guard'
import {getVisionSimulatorModePolicy} from '@/features/scene/services/vision-simulator-mode'
import {
...
import {captureSceneSnapshot} from '@/features/scene/utils/scene-snapshot-capture'
...
import {useEditorShortcuts} from '@/features/scene/hooks/use-editor-shortcuts'
...
import {SimulationAnalysisView} from '@/features/scene/simulation/simulation-analysis-view'
import {loadSimulationCanvasModule} from '@/features/scene/simulation/simulation-canvas-loader'
