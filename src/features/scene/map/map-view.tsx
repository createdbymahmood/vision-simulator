...
import type {
  CursorPoint,
  TooltipState,
} from '@/features/scene/map/map-view-types'
import type {ShapeDrawMode} from '@/features/scene/types/editor/types'

import {SHAPE_STROKE_COLOR} from '@/features/scene/constants/shape-style'
import {
  DEFAULT_WALL_COLOR,
  DEFAULT_WALL_THICKNESS,
} from '@/features/scene/constants/wall-style'
import {useSceneStore} from '@/features/scene/state/scene.store'
import {useUiStore} from '@/features/scene/state/ui.store'
import {MAP_STYLE_URLS} from '@/features/scene/map/map-style-urls'
import {MapViewAreaLayers} from '@/features/scene/map/map-view-area-layers'
import {MapViewCameraLayers} from '@/features/scene/map/map-view-camera-layers'
import {MapViewCameraPreviewLayer} from '@/features/scene/map/map-view-camera-preview-layer'
import {MapViewCursorOverlay} from '@/features/scene/map/map-view-cursor-overlay'
import {
...
import {MapViewPeopleLayers} from '@/features/scene/map/map-view-people-layers'
import {MapViewPersonPreviewLayer} from '@/features/scene/map/map-view-person-preview-layer'
import {MapViewRotationHandleLayer} from '@/features/scene/map/map-view-rotation-handle-layer'
import {MapViewSelectionBoundsLayer} from '@/features/scene/map/map-view-selection-bounds-layer'
import {MapViewSelectionHandlesLayer} from '@/features/scene/map/map-view-selection-handles-layer'
import {MapViewShapeLayers} from '@/features/scene/map/map-view-shape-layers'
import {MapViewTooltip} from '@/features/scene/map/map-view-tooltip'
import {MapViewWallLayers} from '@/features/scene/map/map-view-wall-layers'
import {ensureCanvasGridImages} from '@/features/scene/map/mapbox-grid-images'
import {getCanvasGridStyle} from '@/features/scene/map/mapbox-grid-style'
import {useCameraFovWorker} from '@/features/scene/map/use-camera-fov-worker'
import {useCameraPlacement} from '@/features/scene/map/use-camera-placement'
import {useCanvasEmptyZoom} from '@/features/scene/map/use-canvas-empty-zoom'
import {useFlyToActiveArea} from '@/features/scene/map/use-fly-to-active-area'
import {useMapViewHotkeys} from '@/features/scene/map/use-map-view-hotkeys'
import {usePersonPlacement} from '@/features/scene/map/use-person-placement'
import {
  ENTITY_LAYER_IDS,
  HANDLE_LAYER_IDS,
  useSelectionTransform,
} from '@/features/scene/map/use-selection-transform'
import {useShapeDrawing} from '@/features/scene/map/use-shape-drawing'
import {useWallDrawing} from '@/features/scene/map/use-wall-drawing'
