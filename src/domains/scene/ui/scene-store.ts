...
import { createDefaultScene, createInitialSelection } from "../core/scene-defaults";
import type {
  Scene,
  SceneArea,
  SceneBackground,
...
function createMutator(
  set: Parameters<StateCreator<SceneStore>>[0]
): Mutator {
...
function removeEntityById<T extends { id: string }>(collection: T[], id: string): void {
