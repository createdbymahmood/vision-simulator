...
Start with the product overview at [Product and Core Concepts](overview/product.md).
...
Simulation documentation starts at [Simulation Analysis View](simulation/overview.md) and continues through 3D view and collision, people movement and trails, radar, camera feeds, preview 2D top-down mode, and real radar live detections.
