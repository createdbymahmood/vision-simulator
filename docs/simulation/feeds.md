...
Camera feeds render per-camera POV tiles with detection overlays and appear in the simulation right sidebar under the camera list. Open the sidebar by switching to Preview and look beneath the camera list for the Camera Feeds section.
